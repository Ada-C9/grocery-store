...
describe "Customer" do
  describe "#initialize" do
    ...
    object =  Grocery::Customer.new(35, "brittany.jones.sea@gmail.com", "8903 emerson place" )
    object.id.must_equal 35
    object.email.must_equal "brittany.jones.sea@gmail.com"
    object.delivery_address.must_equal "8903 emerson place"
    end
  end
