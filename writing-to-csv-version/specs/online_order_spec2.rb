...
# require_relative '../lib/online_order2'
#
...
#       # zip_code: "98101-1820"}
#
#     # fake_customer = GroceryTwo::CustomerTwo.new(fake_customer_id, fake_email, fake_address)
#
#     test_order_id = 121
#     test_order_products = {"banana" => 1.99, "cracker" => 3.00}
#
#     fake_online = GroceryTwo::OnlineOrderTwo.new(test_order_id,
...
#       fake_online.must_be_kind_of GroceryTwo::OrderTwo
#
#     end
#
#     it "Can access Customer object" do
#       fake_online.must_respond_to :customer
#       fake_online.customer.must_be_kind_of GroceryTwo::CustomerTwo
#     end
#
...
#       fake_online_fail = GroceryTwo::OnlineOrderTwo.new(test_order_id,
...
#       new_fake_online = GroceryTwo::OnlineOrderTwo.new(3333,
...
#       array_of_all_orders = GroceryTwo::OnlineOrderTwo.all
#       array_of_all_orders.must_be_kind_of Array
#       assert array_of_all_orders.all? { |order| order.class == GroceryTwo::OnlineOrderTwo}
#     end
#
...
#
#       first_order = GroceryTwo::OnlineOrderTwo.all[0]
#
...
#
#       last_order = GroceryTwo::OnlineOrderTwo.all.last
#
...
#         "Smoked Trout"=>70.6, "Cheddar"=>5.63}
#
#       last_order = GroceryTwo::OnlineOrderTwo.find(100)
#
#       last_order.id.must_be_kind_of Integer
#       last_order.id.must_equal 100
#
...
#       assert_raises{GroceryTwo::OnlineOrderTwo.find(9999999)}
#     end
#   end
#
...
#         "Cashews"=>28.49}]
#
#       actual_product_array = GroceryTwo::OnlineOrderTwo.find_by_customer(14)
#
...
#         assert_raises{ GroceryTwo::OnlineOrderTwo.find_by_customer(9999999) }
#     end
#
