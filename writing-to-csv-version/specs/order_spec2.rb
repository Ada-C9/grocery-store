...
# require_relative '../lib/orders2'
#
# describe "Order Wave 1" do
#   describe "#initialize" do
#     it "Takes an ID and collection of products" do
#       id = 1337
#       order = GroceryTwo::OrderTwo.new(id, {})
#
...
#       order = GroceryTwo::OrderTwo.new(1337, products)
#
...
#       order = GroceryTwo::OrderTwo.new(1337, {})
...
#       array_of_all_orders = GroceryTwo::OrderTwo.all
#
#       array_of_all_orders.must_be_kind_of Array
#
#       assert array_of_all_orders.all? { |order| order.class == GroceryTwo::OrderTwo}
#
#     end
#
...
#
#       first_order = GroceryTwo::OrderTwo.all[0]
#
...
#
#       last_order = GroceryTwo::OrderTwo.all.last
#
...
#       #   "Wholewheat flour"=>1.93, "Grape Seed Oil"=>74.9}
#
#       # first_order = GroceryTwo::OrderTwo.find(1)
#
#       first_order = GroceryTwo::OrderTwo.find(1)
#       expected_first_order = GroceryTwo::OrderTwo.all[0]
#
#
#
#       first_order.must_be_kind_of GroceryTwo::OrderTwo
#       expected_first_order.must_be_kind_of GroceryTwo::OrderTwo
#
...
#         "UnbleachedFlour"=>80.59}
#
#       last_order = GroceryTwo::OrderTwo.find(expected_last_order_id)
#
...
#       not_found = GroceryTwo::OrderTwo.find("foo")
